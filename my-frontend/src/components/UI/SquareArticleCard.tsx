...
export default function SquareArticleCard({ article }: { article: Article }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        {/* 分类标签 (悬浮在左上角) */}
        {article.Category && (
          <div className="absolute top-4 left-4 bg-white/95 backdrop-blur text-secondary text-xs font-bold px-3 py-1.5 rounded-md shadow-sm uppercase tracking-wider z-10">
