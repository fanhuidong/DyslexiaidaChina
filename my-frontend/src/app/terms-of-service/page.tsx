...
export default async function TermsOfServicePage() {
  // 从 Strapi 后台获取使用条款数据
  const data = await fetchAPI("/terms-of-service", { populate: "*" });
    ...
    return (
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">请确保 Strapi 后台 "Terms Of Service" 单页已发布。</p>
        </div>
      </div>
    );
  }
  ...
  // 强转类型
  const termsOfServiceData = data as TermsOfServiceData;
    ...
    <main className="min-h-screen bg-off-white">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
        ...
        <div className="prose-lg">
          <BlockRenderer content={termsOfServiceData.Content} />
        </div>
      </div>
    </main>
  );
