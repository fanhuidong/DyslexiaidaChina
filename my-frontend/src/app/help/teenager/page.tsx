...
export default async function HelpTeenagerPage() {
  ...
  // 获取页面配置
  try {
    pageConfig = await fetchAPI("/help-teenager-page-config", { populate: "*" }) as PageConfig | null;
  } catch (error) {
  ...
  const pageTitle = pageConfig?.Title || "青少年";
