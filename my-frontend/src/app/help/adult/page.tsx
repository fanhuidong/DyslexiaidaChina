...
export default async function HelpAdultPage() {
  ...
  // 获取页面配置
  try {
    pageConfig = await fetchAPI("/help-adult-page-config", { populate: "*" }) as PageConfig | null;
  } catch (error) {
  ...
  const pageTitle = pageConfig?.Title || "成年人";
